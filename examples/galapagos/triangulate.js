...
const buffer    = fs.readFileSync('/Users/fmaerten/data/arch/galapagos-all/model2/result-forward-dikes.xyz', 'utf8')
...
fs.writeFile('/Users/fmaerten/data/arch/galapagos-all/model2/result-forward-dikes.ts', io.encodeGocadTS(dataframe2), 'utf8', err => {})
