...
if (params.inverse && params.inverse.active) {
    ...
    fs.writeFileSync(params.model.path + params.inverse.out.path + params.inverse.out.filename, bufferOut, 'utf8', err => {})
}
else {
...
if (params.forward !== undefined && params.forward.active) {
    ...
    fs.writeFileSync(params.model.path + params.forward.grid.out.path + params.forward.grid.out.filename, io.encodeGocadTS(grid, {
