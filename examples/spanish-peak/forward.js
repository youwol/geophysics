...
*/
const userAlpha = [76.75, 0.00667, 0.02172, 2900, 2600, 3697912]
...
const surfs = io.decodeGocadTS(fs.readFileSync(path + '/volcano.ts', 'utf8'), {
    repair: false,
})
const chambers = []
...
grid.series['Joint'] = geo.generateJoints({
    stress: grid.series['S'],
    projected: true,
}) //.map( v => [v[1], -v[0], 0])
