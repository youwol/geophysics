...
export class JointData extends Data {
    ...
    constructor(
        {dataframe, measure, compute, weights, weight, useNormals=true, projected=false, useAngle=true}:
        {dataframe: DataFrame, measure: string, compute?: string[], weights?: string, weight?: number, useNormals?: boolean, projected?: boolean, useAngle?: boolean})
    {
